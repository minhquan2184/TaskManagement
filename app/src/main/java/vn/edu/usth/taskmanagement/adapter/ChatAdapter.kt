package vn.edu.usth.taskmanagement.adapter
...
import vn.edu.usth.taskmanagement.databinding.ItemChatMessageBinding
...
class ChatAdapter : ListAdapter<ChatMessage, ChatAdapter.ChatViewHolder>(ChatDiffCallback()) {
    ...
    class ChatViewHolder(private val binding: ItemChatMessageBinding) :
        ...
        fun bind(message: ChatMessage) {
            binding.tvSenderName.text = message.actorName
